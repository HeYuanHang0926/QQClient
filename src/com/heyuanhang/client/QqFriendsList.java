...
import com.heyuanhang.clientThread.AdministrationQqChatHashMap;
...
public class QqFriendsList extends JFrame implements ActionListener, MouseListener {
    ...
    public static void main(String[] args) {
        QqFriendsList list = new QqFriendsList("1");
        list.addWindowListener(new WindowAdapter() {
            @Override
            public void windowClosing(WindowEvent e) {
                System.out.println("QQ退出了!");
            }
        });
    }
    ...
    public void upateFriend(Message m) {
        String onLineFriend[] = m.getMsg().split(" ");
    ...
    public QqFriendsList(String ownerId) {
        ...
        for (int i = 0; i < jb1s.length; i++) {
            jb1s[i] = new JLabel(1000000 + (i + 1) + "", new ImageIcon("image/mm.jpg"), JLabel.LEFT);
    ...
    public void mouseClicked(MouseEvent arg0) {
        ...
        if (arg0.getClickCount() == 2) {
            ...
            //将qqChat装入到集合中
            AdministrationQqChatHashMap.addQqChat(this.owner + " " + friendNo, qqChat);
        }
    }
